...
class ColorPicker {
    ...
    toDOM() {
        ...
        <div class="cp">
            <div class="cp-header">
                <div class="cp-title">
                    <img class="cp-icon" src="${img$5}">
                    <span class="cp-title-text"> Color Swatches </span>
                </div>
                <img class="cp-close" src="${img$4}"/>
            </div>
            ...
            <div class="cp-body">
                ...
                <div class="cp-body-mode-right">
                    <button class="cp-mode-btn cp-model-indicator"> 
                        <img class="cp-mode-btn-img" src="${img}"/>
