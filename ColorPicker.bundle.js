...
class SliderMode extends ColorMode {
    ...
    createHSL() {
        ...
        new Slider(parent, colorAsHSL[0], 0, 360, 'Hue', '200px', Localized('Hue'), (value) => updateHSLColor(0, value), true);
        new Slider(parent, colorAsHSL[1], 0, 100, 'Saturation', '200px', Localized('Saturation'), (value) => updateHSLColor(1, value), true);
        new Slider(parent, colorAsHSL[2], 0, 100, 'Luminance', '200px', Localized('Luminance'), (value) => updateHSLColor(2, value), true);
    }
...
class ColorPicker {
    ...
    updateColorParameters() {
        ...
        if (this.displayParameter == 'RGBA') {
            ...
            // HSLA display
            const hsla = RGBAToHSLA(this.state.currentColor[0], this.state.currentColor[1], this.state.currentColor[2], this.state.currentColor[3]);
